...
<head>
  ...
  <meta name="title" content="Sorry Website 2.0 | Aoudumber Bade">
  <meta name="github" content="https://github.com/Aoudumber-Bade">
  <title>Sorry Mazhar</title>
...
<body>
  <div id="wrapper">
      ...
      <div class="left">
        ...
        <div class="btn">
          <button id="btn__letter">
            <div class="mail">Click Here Mazhar <i class="fa-regular fa-envelope"></i></div>
          </button>
        </div>
      </div>
    ...
    <div class="decorate_flower--one"><img width="20" src="./images/decorate_flower.png" alt=""></div>
    ...
    <div class="boxMail">
      ...
      <div class="boxMail-container">
        <div class="card1">
          <div class="smiley_icon"><img src="images/smiley_icon.png" alt=""></div>
          <h4 class="username">To: Mazhar 💖<span class="underline"></span></h4>
          <h3>I am</h3>
        ...
        <div class="card2">
          <div class="card2-content">
            <h3>sorry Mazhar!</h3>
            <h2>I am sorry! I forgot to turn on my internet 😅</h2>
  ...
  <script>
    let datetxt = "16 October";
    let datatxtletter = "My love. You are very special. I always silently thank you for coming into my life.";
    let titleLetter = "I am sorry!";
